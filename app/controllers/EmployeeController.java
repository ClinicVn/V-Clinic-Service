...
public class EmployeeController extends Controller {
    ...
    public Result get(Integer id) {
        ...
        return JsonController.jsonResult(ok(Json.toJson(employee)));
    }
    ...
    public Result create() {
        ...
        if (employee.hasErrors()) {
            return JsonController.jsonResult(badRequest(employee.errorsAsJson()));
        }
        Employee newEmployee = EmployeeService.create(employee.get());
        return JsonController.jsonResult(created(Json.toJson(newEmployee)));
    }
    ...
    public Result update() {
        ...
        return JsonController.jsonResult(ok(Json.toJson(updatedEmployee)));
    }
